...
def test_generate_password_minimum_length():
    password = passlock.generate_password(
        length=4,
        num_uppercase=1,
        num_lowercase=1,
        num_digits=1,
...
# ===============================================================
# TEST: PASSWORD TOTAL CHARACTER COUNT EXCEEDS LENGTH

def test_generate_password_characters_exceeds_length():
    with pytest.raises(ValueError):
        passlock.generate_password(
            length=6,
            num_uppercase=2,
            num_lowercase=2,
            num_digits=2,
